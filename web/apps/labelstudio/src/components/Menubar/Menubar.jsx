                ...
                {showNewsletterDot && (
                  <>
                    ...
                    <Menu.Item className={cn("newsletter-menu-item")} href={pages.AccountSettingsPage.path}>
                      <span>{t('menubar.newsletterNotification')}</span>
      ...
      <VersionProvider>
        <div className={contentClass.elem("body")}>
          {enabled && (
            ...
            >
              <Menu>
                {isFF(FF_HOMEPAGE) && <Menu.Item label={t('menubar.home')} to="/" icon={<IconHome />} data-external exact />}
                <Menu.Item label={t('menubar.projects')} to="/projects" icon={<IconFolder />} data-external exact />
                <Menu.Item label={t('menubar.organization')} to="/organization" icon={<IconPersonInCircle />} data-external exact />
                ...
                <Menu.Item
                  ...
                  target="_blank"
                />
                <Menu.Item label={t('menubar.docs')} href="https://labelstud.io/guide" icon={<IconBook />} target="_blank" />
                <Menu.Item
