  ...
  return (
    <div className={cn("ml").elem("status")}>
      ...
      <Oneof value={state} className={cn("ml").elem("status-label")}>
        <span case="DI">{t('model.status.disconnected')}</span>
        <span case="CO">{t('model.status.connected')}</span>
        <span case="ER">{t('model.status.error')}</span>
        <span case="TR">{t('model.status.training')}</span>
        <span case="PR">{t('model.status.predicting')}</span>
      </Oneof>
    </div>
  );
};
