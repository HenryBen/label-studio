...
export const GeneralSettings = () => {
  ...
  const samplings = [
    { value: "Sequential", label: t('generalSettings.sequentialSampling'), description: t('generalSettings.sequentialDescription') },
    { value: "Uniform", label: t('generalSettings.randomSampling'), description: t('generalSettings.randomDescription') },
  ];
        ...
        <Block name="settings-wrapper">
          <Form action="updateProject" formData={{ ...project }} params={{ pk: project.id }} onSubmit={updateProject}>
              ...
              {isFF(FF_LSDV_E_297) && (
                <Block name="workspace-placeholder">
                  ...
                  <Typography size="small" className="my-tight">
                    {t('generalSettings.workspaceDescription')}{" "}
                    <a
                      target="_blank"
                      href={createURL(
              ...
              <RadioGroup label={t('generalSettings.taskSampling')} labelProps={{ size: "large" }} name="sampling" simple>
                ...
                {isFF(FF_LSDV_E_297) && (
                  <RadioGroup.Button
                    ...
                    description={
                      <>
                        {t('generalSettings.uncertaintyDescription')}{" "}
                        <a
                          target="_blank"
            ...
            <Form.Actions>
              ...
              <Button type="submit" className="w-[150px]" aria-label={t('generalSettings.saveAriaLabel')}>
