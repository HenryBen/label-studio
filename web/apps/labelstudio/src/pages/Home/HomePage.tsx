...
const getActions = (t: any) => [
  {
    title: t('homepage.createProject'),
    icon: IconFolderAdd,
    type: "createProject",
  },
  {
    title: t('homepage.invitePeople'),
    icon: IconUserAdd,
    type: "invitePeople",
  },
] as const;

type Action = "createProject" | "invitePeople";
        ...
        <section className="flex flex-col gap-6">
          ...
          >
            {isFetching ? (
              ...
              <div className="h-64 flex justify-center items-center">{t('homepage.cantLoadProjects')}</div>
              ...
              <div className="flex flex-col justify-center items-center border border-primary-border-subtle bg-primary-emphasis-subtle rounded-lg h-64">
                ...
                <Typography variant="headline" size="small">
                  {t('homepage.createFirstProject')}
                </Typography>
                <Typography size="small" className="text-neutral-content-subtler">
                  {t('homepage.projectDescription')}
                </Typography>
