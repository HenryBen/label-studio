      ...
      <Block name="export-page">
        ...
        <Elem name="footer">
          <Space style={{ width: "100%" }} spread>
            ...
            <Elem name="actions">
              <Space>
                {downloadingMessage && t('exportPage.preparingFiles')}
                <Button className="w-[135px]" onClick={proceedExport} waiting={downloading} aria-label={t('exportPage.exportButton')}>
                  {t('exportPage.exportButton')}
                </Button>
              </Space>
            </Elem>
          </Space>
...
const FormatInfo = ({ availableFormats, selected, onClick }) => {
  ...
  return (
    <Block name="formats">
      <Elem name="info">{t('exportPage.formatInfo')}</Elem>
      <Elem name="list">
