...
const SideTabsPanelsComponent: FC<SidePanelsProps> = ({
  ...
  const getPartialEmptyBaseProps = useMemo(() => {
    const baseProps = createPartialEmptyBaseProps(t);
    const updatedProps = { ...baseProps };

    updatedProps.panelViews = baseProps.panelViews.filter(
