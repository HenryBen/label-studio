...
const DetailsPanelComponent: FC<DetailsPanelProps> = ({ currentEntity, regions, ...props }) => {
  ...
  return (
    <PanelBase {...props} currentEntity={currentEntity} name="details" title={props.tooltip}>
          ...
          <Elem name="section-tab">
            {hasRelations ? (
              ...
              <EmptyState
                ...
                header={t('labelingConfig.detailsPanel.relations.emptyState.header')}
                description={<>{t('labelingConfig.detailsPanel.relations.emptyState.description')}</>}
                learnMore={{
                  href: getDocsUrl("guide/labeling#Add-relations-between-annotations"),
                  text: t('labelingConfig.detailsPanel.relations.emptyState.learnMore'),
          ...
          <Elem name="section-tab">
            {nothingSelected ? (
              <EmptyState
                ...
                header={t('labelingConfig.detailsPanel.info.emptyState.header')}
                description={<>{t('labelingConfig.detailsPanel.info.emptyState.description')}</>}
              />
            ) : (
              <>
