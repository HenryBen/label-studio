  ...
  ({ comment, listComments, classificationsItems }: CommentItemProps) => {
    ...
    return (
      <Block
        ...
        ref={_commentRef}
      >
        <Space spread size="medium" truncated className="" style={{}}>
          <Space size="small" truncated className="" style={{}}>
          ...
          <Space size="small" className="" style={{}}>
          ...
          >
            {isPersisted && (isCreator || canResolveAny) && (
              <Dropdown.Trigger
                content={
                  <div>
                    <div onClick={toggleResolve}>{resolved ? "Unresolve" : "Resolve"}</div>
                    {isCreator && (
                      <>
                        <div
                          onClick={() => {
                        ...
                        <div onClick={toggleLink}>{regionRef?.region ? "Unlink" : "Link to..."}</div>
                        {!isConfirmDelete && (
                          <div
                            onClick={() => {
                              setConfirmMode(true);
