  ...
  .actions((self) => ({
    ...
    confirmLabelingConfigured() {
      if (!self.labelingIsConfigured) {
        Modal.confirm({
          title: i18n.t('dataManager.dialogs.labelingConfiguration.title'),
          body: i18n.t('dataManager.dialogs.labelingConfiguration.text'),
          onOk() {
            self.SDK.invoke("settingsClicked");
          },
          okText: i18n.t('dataManager.dialogs.labelingConfiguration.goToSetup'),
        });
        return false;
      }
      return true;
