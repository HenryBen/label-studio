    ...
    <Space style={{ fontSize: 12 }}>
      <ButtonGroup collapsed {...rest}>
        <FieldsButton
          ...
          title={ordering ? ordering.column?.title : t('dataManager.toolbar.orderBy')}
          onClick={(col) => view.setOrdering(col.id)}
          onReset={() => view.setOrdering(null)}
          resetTitle={t('dataManager.toolbar.default')}
        ...
        <Button
          ...
          aria-label={ordering?.desc ? t('dataManager.toolbar.sortAscending') : t('dataManager.toolbar.sortDescending')}
        >
