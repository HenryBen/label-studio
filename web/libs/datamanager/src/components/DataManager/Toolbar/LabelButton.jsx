      ...
      <div>
        <ButtonGroup>
          <Button
            ...
            onClick={onLabelAll}
          >
            {selectedCount ? t('dataManager.toolbar.labelTasks') : t('dataManager.toolbar.labelAllTasks')} {selectedCount || ''} {!selectedCount || selectedCount > 1 ? t('dataManager.toolbar.tasks') : t('dataManager.toolbar.task')}
          </Button>
          <Dropdown.Trigger
            align="right"
            content={
              <Menu size="compact">
                <Menu.Item onClick={onLabelVisible}>{t('dataManager.toolbar.labelTasksAsDisplayed')}</Menu.Item>
              </Menu>
            }
          >
