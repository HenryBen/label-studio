...
const ImportButtonWithChecks = ({ size }) => {
  ...
  const simpleButton = <ImportButton size={size}>{t('dataManager.toolbar.import')}</ImportButton>;
...
export const instruments = {
    ...
    const ColumnsButton = () => {
      ...
      return (
        <FieldsButton
          ...
          title={t('dataManager.toolbar.columns')}
          size={size}
          style={style}
  ...
  "export-button": ({ size }) => {
    const ExportButtonWithTranslation = () => {
      const { t } = useTranslation();
      return (
        <Interface name="export">
          <ExportButton size={size}>{t('dataManager.toolbar.export')}</ExportButton>
        </Interface>
      );
    };
    return <ExportButtonWithTranslation />;
  },
};
