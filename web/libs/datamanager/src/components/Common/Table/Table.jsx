    ...
    const headerCheckboxCell = useCallback(() => {
      return (
        <TableCheckboxCell
          ...
          ariaLabel={`${selectedItems.isAllSelected ? t('dataManager.table.unselectAllRows') : t('dataManager.table.selectAllRows')}`}
        />
      );
      ...
      ({ data }) => {
        ...
        return (
          <TableCheckboxCell
            ...
            ariaLabel={`${isChecked ? t('dataManager.table.unselectTask') : t('dataManager.table.selectTask')} ${data.id}`}
          />
        );
      },
          ...
          >
            {isFF(FF_DEV_3873) ? (
              <FieldsButton
                ...
                icon={<IconGearNewUI />}
                style={{ padding: "0" }}
                tooltip={t('dataManager.table.customizeColumns')}
              />
            ) : (
              <FieldsButton
                wrapper={FieldsButton.Checkbox}
  ...
  return (
    ...
    >
      <div style={{ padding: "16px", paddingTop: "16px" }}>
        <Tooltip title={copied ? t('dataManager.table.copied') : t('dataManager.table.copyJSON')}>
          <Button
            look="string"
            variant="neutral"
            style={{
