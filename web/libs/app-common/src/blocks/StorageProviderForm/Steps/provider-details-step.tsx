    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <Input
          ...
          placeholder={t('storage.storageTitlePlaceholder')}
          validate=""
          skip={false}
          labelProps={{}}
          ghost={false}
          ...
          tooltipIcon={null}
          required={true}
          label={t('storage.storageTitle')}
          description={t('storage.storageTitleDescription')}
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <Toggle
              ...
              aria-label={t('storage.canDeleteObjects')}
              label={t('storage.canDeleteObjects')}
              description={t('storage.canDeleteObjectsDescription')}
            />
          </div>
        </div>
      )}
